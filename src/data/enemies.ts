...
export const DEMIGOD_WARRIOR_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['demigod_strike', 'celestial_beam'],
  apRegen: 5,
  maxAp: 12,
  isBoss: false,
...
export const CELESTIAL_GUARDIAN_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['angelic_smite', 'angelic_blessing'],
  apRegen: 5,
  maxAp: 12,
  isBoss: false,
...
export const ARCHANGEL_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['angelic_smite', 'angelic_blessing', 'celestial_beam', 'boss_summon', 'boss_enrage'],
  apRegen: 7,
  maxAp: 15,
  isBoss: true,
  bossMultiplier: 2.5,
...
export const LESSER_GOD_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['godly_wrath', 'primordial_crush'],
  apRegen: 7,
  maxAp: 14,
  isBoss: false,
...
export const PRIMORDIAL_TITAN_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['primordial_crush', 'titan_slam'],
  apRegen: 6,
  maxAp: 14,
  isBoss: false,
...
export const VOID_ENTITY_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['void_erasure', 'godly_wrath'],
  apRegen: 8,
  maxAp: 14,
  isBoss: false,
  equipmentDropChance: 1.0,
...
export const WORLD_DESTROYER_TEMPLATE: EnemyTemplate = {
  ...
  abilities: ['godly_wrath', 'void_erasure', 'primordial_crush', 'boss_summon', 'boss_enrage'],
  apRegen: 8,
  maxAp: 16,
  isBoss: true,
  bossMultiplier: 2.5,
